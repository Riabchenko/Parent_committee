...
import static com.committee.security.codec.Base64.*;
...
public class SCryptUtil {
	...
	public static String scrypt(String passwd, int N, int r, int p) {
		try {
			...
			byte[] derived = SCrypt.scrypt(passwd.getBytes("UTF-8"), salt, N, r, p,
					32);
	...
	public static boolean check(String passwd, String hashed) {
		try {
			...
			byte[] derived1 = SCrypt.scrypt(passwd.getBytes("UTF-8"), salt, N, r, p,
					32);
