...
package com.committee.security.codec;
 ...
 *
 * Decoding assumes correct input, the caller is responsible for ensuring that
 * the input contains no invalid characters.
 *
 * @author Will Glozer
 */
public class Base64 {
