	...
	<div class="container">
		<div class="content">
			...
			<div class="main">
				<div id="content">
					<h1>
						<label><jgc:Language>newMail</jgc:Language></label>
					</h1>
					<!--  ------------------------ Error ------------------------ -->
						...
						<form action="ServletAdmin" method="POST">
							...
							<table class="outline2">
								<tbody align="center">
									...
									<tr>
										<td><jgc:Language>recipient</jgc:Language>
									...
									<tr>
										<td><jgc:Language>subject</jgc:Language><input type="text" size="40" name="subject"></td>
									</tr>
									<tr>
							...
							<div>
								<input type="submit" name="mainForMail" value="<jgc:Language>send</jgc:Language>">
							</div>
						</form>
					</div>
				</div>
